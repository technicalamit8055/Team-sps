...
-- ------------------------------------------------------------------------------
-- Verification. Expect exactly one UPDATE policy row, named
-- "Workers can update unit donations", with both a USING and a WITH CHECK
-- expression -- and no surviving "Workers can update own donations".
-- ------------------------------------------------------------------------------
SELECT policyname,
       cmd,
